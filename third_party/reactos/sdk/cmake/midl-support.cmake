...
function(add_rpc_file _type _idl_file)
    ...
    add_custom_command(
        OUTPUT ${_name_we}.c ${_name_we}.h
        COMMAND midl ${_includes} ${_defines} ${IDL_FLAGS} ${_additional_flags} /h ${_name_we}.h ${_server_client} ${_name_we}.c ${_prevent_second_type} ${_idl_file}
        DEPENDS ${_idl_file})
endfunction()
